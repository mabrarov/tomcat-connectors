...
function(jk_list_subdirs files base_dir results)
...
function(jk_filter_files files base_dir filter_dir results)
    get_filename_component(cmake_base_dir "${base_dir}" ABSOLUTE)
...
function(jk_dir_source_group base_group_name base_dir files)
    jk_list_subdirs("${files}" "${base_dir}" subdirs)
    foreach(subdir IN LISTS subdirs)
        string(REPLACE "/" "\\" subdir_group_name "${base_group_name}/${subdir}")
        jk_filter_files("${files}" "${CMAKE_CURRENT_BINARY_DIR}" "${base_dir}/${subdir}" subdir_files)
...
function(jk_set_target_output_dir target_name output_dir)
...
function(jk_list_to_string list separator result)
    set(str )
    set(first_item TRUE)
